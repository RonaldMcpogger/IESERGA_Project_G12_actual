...
public class Scene3Dialogue : MonoBehaviour
{
    ...
    public void Next()
    {
        ...
        {
            Char2speech.text = "We don’t have time to play nice, so torture them to loosen their lips. They'll be begging to tell us what we want in no time.";
        }
        else if (primeInt == 7)
        {
        ...
        {
            Char2name.text = "Hauptmann Schwarz";
            Char2speech.text = "I’ll remind you that we cannot afford to follow the international law if we want to win. We are fighting for our country’s cause! If you keep on refusing to follow my orders, I will have you executed for treason!";
        ...
        {
            Char2speech.text = "Hauptmann Schwarz didn’t hear any sounds of the prisoner’s pain.";
        }
        else if (primeInt == 61)
        {
            Char2name.text = "Hauptmann Schwarz";
        ...
        {
            Char2speech.text = "Article 14: Respect for Prisoners’ Honor and Rights";
        }
        else if (primeInt == 68)
        {
            SceneManager.LoadScene("Scene4");
